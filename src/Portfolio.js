                            ...
                            <div className="card-deck">
                                <div className="card bg-dark text-white">
                                    <a href="https://mjp1986.github.io/projectone/" id="custom-card">
                                        <img className="card-img" src="https://github.com/MESellassie/profilemereact/blob/master/public/assets/final-screen-capture.jpg?raw=true" alt="Farm 2 Tablet" />
                                ...
                                <div className="card bg-dark text-white">
                                    <a href="https://mesellassie.github.io/planner.github.io/" id="custom-card">
                                        <img className="card-img" src="https://github.com/MESellassie/profileMEReact/blob/master/public/assets/laptop-1805315_640.jpg?raw=true" alt="Laptop BandW" />
                                        <div className="card-img-overlay">
                                ...
                                <div className="card bg-dark text-white">
                                    <a href="https://mesellassie.github.io/weatherdashboard/" id="custom-card">
                                        <img class="card-img" src="https://github.com/MESellassie/profileMEReact/blob/master/public/assets/rain-791893_640.jpg?raw=true" alt="GA Gov Comparison" />
                                        <div className="card-img-overlay">
                            ...
                            <div className="card-deck">
                                <div className="card bg-dark text-white">
                                    <a href="https://thisistheway.herokuapp.com/" id="custom-card">
                                        <img className="card-img" src="https://github.com/MESellassie/profileMEReact/blob/master/public/assets/northernLights.jpg?raw=true" alt="Northern Lights" />
                                        <div className="card-img-overlay">
                                ...
                                <div className="card bg-dark text-white">
                                    <a href="https://googlethatbooksearch.herokuapp.com/" id="custom-card">
                                        <img className="card-img" src="https://github.com/MESellassie/profileMEReact/blob/master/public/assets/boyReading.jpg?raw=true" alt="boyInLibrary" />
                                        <div className="card-img-overlay">
                                ...
                                <div className="card bg-dark text-white">
                                    <a href="https://mesellassie.github.io/herodirectory/" id="custom-card">
